...
public class TestCase_02005 extends TestBaseRapor {
    ...
    public void ListOfUsersYazisiTesti() {
        ...
        Assert.assertTrue(hotelMyCampPage.basariliGirisYaziElementi.isDisplayed(),"ListOfUsers yazisi görülemiyor ");
