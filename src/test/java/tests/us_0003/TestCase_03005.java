...
public class TestCase_03005 extends TestBaseRapor {
   KayitRegistrationPage kayitRegistrationPage=new KayitRegistrationPage();
    @Test
    public void test01(){
        extentTest=extentReports.createTest("HotelMyCamp us_0003  TestCase_03005","https://hotelmycamp.com test edildi");
        //5)User Data was inserted successfully yazisinin görünürlügü kontrol edilmeli ve ok butonuna basilmali
        ...
        extentTest.info("kayit sayfasinin görünürlügü test edildi");
       ...
       extentTest.info("Driving License boxunun görünürlügü test edildi");
        ...
        extentTest.info("Woorking Sector boxunun görünürlügü test edildi");
        ...
        //"User Data was inserted succesfully" yazisinin görüntülendigi kontrol edildikten sonra ok butonuna basilmali
        ReusableMethods.waitFor(1);
        Assert.assertTrue(kayitRegistrationPage.basariliKayitYazisi.isDisplayed());
        extentTest.info("basarili kayit yazisi görünürlügü test edildi");
        kayitRegistrationPage.registerOkButonu.click();
    }
}