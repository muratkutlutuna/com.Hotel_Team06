...
public class TestCase_03003 extends TestBaseRapor {

    KayitRegistrationPage kayitRegistrationPage=new KayitRegistrationPage();

    @Test
    public void test01(){
        extentTest=extentReports.createTest("HotelMyCamp us_0003  TestCase_03003","https://hotelmycamp.com test edildi");

        //3)kayit sayfasindaki textboxlarin görünürlügü kontrol edilip bilgiler girilmeli
       ...
       kayitRegistrationPage.eMailBox.sendKeys(faker.internet().emailAddress());
        ...
        extentTest.info("Driiving License boxunun görünürlügü test edildi");
